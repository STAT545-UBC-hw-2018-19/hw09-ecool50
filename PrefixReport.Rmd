...
* Plot a word cloud of all the prefixes.
* Make some comments
...
I wonder if this is actually the case. Lets do a more rigorous test: "`r with(data, value[which.max(freq)])`". It indeed is `con` that is the most frequent three letter prefix. I wonder how this will change if you increase the number of letter for a prefix.
